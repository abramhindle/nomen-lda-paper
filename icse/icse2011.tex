...
We conducted unsupervised labelling using word-lists. 
...
We also want to leverage different kinds of artifacts to discover threads of NFR-related discussions that occur between multiple kinds of artifacts.
