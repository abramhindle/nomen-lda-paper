...
To understand the latent subject matter of software development artifacts, researchers have introduced topic modeling and concept location.
These techniques rely on the automated application of machine learning algorithms to corpora.
% the problem
Their outputs are word-lists lacking semantic interpretation, which are difficult to distinguish and interpret. 
...
Current topic labelling approaches are manual, and do not use domain-specific knowledge to improve results. Nor to they contextualize those results for developers.   
% a sub problem
...
% we can label stuff
Labelled topic extraction allowed us to devise appropriate, context-sensitive labels across these two projects, providing insight into their software development activities over time.
\end{abstract}
