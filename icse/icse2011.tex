...
% the problem
 Unfortunately the output of these tools is often difficult to distinguish and interpret as they are often so abstract, in particular topics that are automatically extracted are word-lists lacking semantic interpretation.
% the solution 
...
In addressing a topic of development stakeholders often produce or modify multiple development artifacts.
%
