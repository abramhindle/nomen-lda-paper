...
These techniques use unsupervised machine-learning algorithms recover topics.
...
Then these topics given labels relating to a generalizable cross-project taxonomy consisting of non-functional requirements (NFRs).
...
\item We demonstrated a method of visualizing these topics across time.
\end{itemize}
