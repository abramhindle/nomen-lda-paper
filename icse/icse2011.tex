...
\begin{figure*}
  \centering
 \includegraphics[width=.75\textwidth]{figures/unsupervised-bar}
...
\begin{figure*}
  ...
  \includegraphics[height=.55\textheight]{figures/small-maxdb-time-smear-plot-Equal}
...
\begin{figure*}%[h]
  ...
  \includegraphics[width=.97\textwidth]{figures/mysql-timeline}
