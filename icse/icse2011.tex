...
\usepackage[caption=false]{subfig}
 \usepackage[disable,colorinlistoftodos,backgroundcolor=yellow]{todonotes}
 \usepackage{color}
...
\todo[inline,color=yellow]{update this with more detail}
