...
% we can label stuff
Labelled topic extraction allowed us to devise appropriate, context-sensitive labels across these two projects, providing insight into their software development activities.
\end{abstract}
