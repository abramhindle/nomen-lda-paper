...
The topmost row in each the diagram is reserved for historical events of note. 
...
Version 3.23.31 (January, 2001) was the production release (non-beta), and we see a flurry of topics labelled with \emph{functionality} and \emph{maintainability}, as one might expect. 
...
Similarly, in August, 2002, both \emph{functionality} and \emph{portability} are frequent, and mailing list data suggests this is related to the release of version 3.23.52, a general bug fix with a focus on security (encoded as the \emph{functionality} NFR in the ISO9126 model). 
...
This is likely due to our analysis time horizon being shorter than an equivalent span for the MySQL project. %XXXXXXXXXXXXXXXXX what
