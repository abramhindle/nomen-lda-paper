...
% the solution 
In order to have a meaningful discussion about the topics of software development, we must be able to interpret and devise labels for these topics. 
...
% we can label stuff
Labelled topic extraction produces appropriate, context-sensitive labels relevant to these projects, providing insight into their evolving software development activities.
\end{abstract}
...
In this paper we presented a cross-project data mining technique that was appropriate for mining and labelling latent software development topics using a non-functional requirements (NFRs) taxonomy. %topics and artifacts from project histories.
