...
As discussed in the section previous, certain peaks in topic numbers coincide with particular emphases in the development team, such as new releases or bug fixes.
...
In MaxDB, we can observe that \emph{Maintainability} topics became more prevalent as MaxDB matures. This is likely due to our analysis time horizon being shorter than the MySQL product.
