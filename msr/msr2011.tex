...
candidate word-lists that recur together often.  However, word-lists are
difficult to 
...
The development of software does not occur in a vacuum, revisions to
source code are often not independent of the past, the specification or
the task at hand.
...
Accordingly, we tried to associate each topic with a label from a list
of keywords and related terms. These keywords were determined before
hand and were not extracted from the project themselves.
