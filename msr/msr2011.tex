...
In this paper, we had two objectives. One, we sought to automate the process of naming the topics. Two, we sought to label topics with independent terms, in order to facilitate comparison between projects.
