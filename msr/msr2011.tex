...
Within this paper we define \emph{topics} as latent word distributions that describe and compose the documents being analyzed. We then defined \emph{labelled topics} as \emph{topics} that have been 
