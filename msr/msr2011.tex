...
\begin{figure*}
  \centering
 \includegraphics[width=0.7\textwidth]{figures/unsupervised-bar}
...
In this section we demonstrate the value of labelled topic extraction in addressing this issue. 
...
The second, absolute frequency, is shown using cell intensity compares the number of topics labelled with that NFR per period 
relative to the maximum number of labelled topics overall, for that project. For instance, Figure \ref{fig:mysql-timeline} shows that the NFRs \emph{functionality}, \emph{portability} and \emph{maintainability} contain more labelled topics, since these NFRs have been more intensely shaded.
