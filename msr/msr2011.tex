...
Next, we describe how we generated our data (Section \ref{sec:wordlist}) and how we created the word-lists used in unsupervised classification (Section \ref{sec:genwordlist}). 
...
%Our goal is to label a given topic with either an NFR from our taxonomy,
 Section \ref{sec:unsuplabelling} presents our technique for using word-lists to do unsupervised classification, and describes the results. In Section \ref{sec:suplabelling}, we manually annotate the topics, and use those annotations as training data for supervised classification.  
...
The paper concludes with a discussion of limitations (Section \ref{sec:limit}), and some conclusions. 
