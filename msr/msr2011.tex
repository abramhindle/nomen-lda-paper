...
\emph{how}.
In this work we seek to provide automated in labelling development topics extracted from commit logs.
...
related to NFR topics, such as usability.
...
We set the number of topics to generate to $20$, because past experimentation showed that fewer topics might aggregate multiple unique topics while any more topics diluted the results and create indistinct topics~\cite{Hindle09ICSM}. 
