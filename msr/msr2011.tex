...
\todo[inline]{more on the case study early on as a way of showing our technique is useful for insight into dev activities}
...
% EXP2 source is naming-paper/src/validate/exp2.maxdb.report.txt (change as needed). Second column is F1.
