...
The idea of extracting higher-level \emph{concerns}, also known as
\emph{topics}, \emph{concepts}, \emph{aspects} or \emph{requirements},
has been approached from documentation-based and repository-based
perspectives.

Cleland-Huang and her colleagues have investigated on mining requirements documents for non-functional requirements (NFR) (quality requirements)~\cite{Cleland-Huang2006}. 
...
In this paper we make cross-project comparisons instead of focusing
on a single project.
...
They used WordNet for word roots as they felt the synonyms would be non-specific and cause errors, problems we also encountered. 
...
analysis, we extend this with labelled
