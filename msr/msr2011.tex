...
These topics are given labels relating to a generalizable
...
% Topics are extracted using Latent Dirichlet Allocation (LDA) from commit-log comments recovered from source control systems such as CVS and BitKeeper. 
...
\todo[inline]{neil: possible reword: Topic modeling is a machine learning technique which creates multinomial distributions over words found in a text corpus. Topic models are useful in software engineering because they can identify, from text corpora such as source code, change logs, email, and others, co-occuring words. For example, a topic extracted from a set of changelogs might be ``listener change remove add fire''. A topic model gives developers an overview of where activity is occurring and gives managers or maintainers a sense of project history. A major challenge is to accurately identify the label for a topic (in the previous case, perhaps ``event-handling''). Current approaches are manual: they rely on human expertise to recognize the appropriate label. Furthermore, to date the results of topic modeling are project specific, and not generalizable. }


% An attempt Motivate topics
%XXX is this the correct terminology for commits/revisions
%The development of software does not occur in a vacuum, 
Revisions to
...
\todo[inline]{NeiL: I still find this clumsily worded}
...
Such abstractions include project dashboards~\cite{kersten2005mylar} and tags~\cite{treude2010}%, and complexity metrics \cite{mccabe1976complexity}. 
...
\todo{this confused people. Is it truly unsupervised? Yes, but it needs to be clearer.}
...
This is because LDA extracted 20 topics per period. 
...
\begin{figure*}
  \centering
 \includegraphics[width=0.6\textwidth]{figures/unsupervised-bar}
...
% portability,0.773778920308,0.228070175439,76,12,0.181684100119,0.52,0.14606741573,0.553033707865,288,0.96,13
% efficiency,0.832904884319,0.21686746988,36,29,0.124642098177,0.236842105263,0.2,0.557848837209,315,0.915697674419,9
% reliability,0.714652956298,0.379888268156,7,104,0.340426350577,0.246376811594,0.829268292683,0.765208858985,244,0.701149425287,34
% functionality,0.902313624679,0.0952380952381,32,6,0.0834236909204,0.25,0.0588235294118,0.520961060481,349,0.983098591549,2
% maintainability,0.796915167095,0.0919540229885,76,3,0.122505166175,0.571428571429,0.05,0.520145631068,306,0.990291262136,4
% usability,0.830334190231,0.175,11,55,0.138109307712,0.112903225806,0.388888888889,0.620320455226,316,0.851752021563,7

% total,0.808483290488,0.235897435897,238,209,0.126930463023,0.248201438849,0.224755700326,0.560823829443,1818,0.896891958559,69mysql

% portability,0.616040955631,0.137931034483,225,0,0.211497874858,1.0,0.0740740740741,0.537037037037,343,1.0,18
% efficiency,0.924914675768,0.3125,33,11,0.297817974114,0.47619047619,0.232558139535,0.606150156324,532,0.979742173112,10
% reliability,0.726962457338,0.411764705882,61,99,0.242477699079,0.361290322581,0.478632478632,0.633772529295,370,0.788912579957,56
