...
We began by gathering source data and creating topic models. For unsupervised labelling, we generate three sets of wordlists as signifiers for NFRs.
...
%% NEIL: this should be in the intro or conclusion, not this section.
%This paper does this differently. First of all, we automated the process of naming the topics. Secondly, we labelled topics with project-independent terms, in order to permit cross-project comparison.
...
Our second word-list, \textsf{exp2}, uses the ISO9126 taxonomy described above (Section \ref{sec:wordlist}) to seed the wordlists.
...
\textbf{Generating labels automatically}
