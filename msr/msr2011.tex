...
We began by gathering source data and creating topic models. We created labels using a well-known NFR taxonomy. 
We then applied unsupervised and supervised learning techniques to try to match our labels to the topics. 
