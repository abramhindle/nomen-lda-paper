...
CPUS=3
perl make-single-class-arff-files.pl pgsqla && make -f Makefile.pgsql -j $CPUS all
perl make-single-class-arff-files.pl pgsqln && make -f Makefile.pgsql -j $CPUS all
