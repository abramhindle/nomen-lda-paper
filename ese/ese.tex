...
5.0). 
\todo{add PGSQL disucssion here. Schema additions? Lots of functionality?}
...
on the appropriate annotation for that topic. We verified IRR using manually annotated PostgreSQL topics, and achieved a result of \todo[inline]{insert here}. 
