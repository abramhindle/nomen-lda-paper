...
For each quality we assessed whether semi-unsupervised labels matched the manual annotations. %To be clear, the manual annotations were not used to
...
We assessed inter-rater reliability (IRR) using Cohen's Kappa to measure the level of agreement between the manual 
annotations the first two authors created, under some model of random agreement. Perfect IRR (1.0) indicates 
complete agreement on the appropriate annotation for that topic. We verified IRR using manually annotated PostgreSQL topics, 
and achieved a result of 0.108 (slight agreement), with a correlation coefficient of 0.108. 
...
usability or portability?), and a disagreement on functionality as a software quality. A short education session on the meaning of a given NFR from 
the ISO standard would reduce this error rate.
In general there is disagreement over what constitutes a non-functional requirement \cite{Glinz_2007}.
