...
%new stuff
% edit this. awkward
In this work we provide a method of automatically labelling  development topics extracted from commit logs.

Concrete applications of topics and \emph{labelled topic extraction}, which this paper introduces,
...
(MSR'2011). The major extensions in this paper are as follows:
\begin{itemize}
	\item We added more machine learning results and another case-study: PostgreSQL. 
...
were
\emph{correctness} (182/305/748, which represent MySQL, MaxDB and PostgreSQL topic counts, respectively) and \emph{testability} (121/238/625). 
...
intensely shaded. One interesting stream is \emph{efficiency}, which shows periodic
...
the NFRs that they worked on. 
Within this section we focused on PostgreSQL.
We first conducted pairwise $X^2$ (chi-squared)
tests and Kolmogorov-Smirnov tests for each developer pair. We
found that in $3/10$ of these tests, the developers were significantly
different, i.e., their distributions were not similar. This implies
...
we compare the global NFR distribution to each author we find that 25\%
 of the authors have a similarity of $0.47$ or less. This is
...
Given these results we found that there indeed was a focus
...
this 10000 times, we found that
for 4 out of 7 NFR labels, our labels IRR were greater than the random
IRR measures 95\% of the time. For portability and efficiency, our IRR
