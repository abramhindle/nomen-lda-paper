...
on a single project.
They relied on requirements documents instead of version control histories that we use.
...
work of Ernst
et al.~\cite{ernst10refsq} and the work of Hindle et
al.~\cite{Hindle09ICSM}.
In Ernst et al.~\cite{ernst10refsq}, we describe our earlier
...
This work, and our
MSR'2011 paper~\cite{msr2011}, extend this work by using 
word-lists to label extracted topics.
 Hindle et
al.~\cite{Hindle09ICSM}
...
buckets, and joined if deemed sufficiently similar. This work, and our
MSR'2011 paper~\cite{msr2011}, extend this method by labelling topics
