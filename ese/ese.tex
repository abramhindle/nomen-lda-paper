...
flooded with many terms, indicating that perhaps we needed more 20 topics per month
...
PostgreSQL, MaxDB and MySQL. We omit plots of \textsf{exp1} due to poor results. We describe F-1 results in the text below.
...
correlation distance ($1 - r$). Whereas, Euclidean distance uses both angle and magnitude of a
...
and the union of both Neil and Abram. 
...
\begin{figure}
  ...
  \caption{Measured IRR versus IRR of random labeling
    ...
    The red line and points highlight the inter-rater reliability of
    NFR topics labels
    ...
    labelling of NFRs.
    Note how for 4 of the 7 NFRs it is
