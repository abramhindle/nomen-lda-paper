...
** [ ] Make a response document
   - [ ] Aggregate responses per each of these points (re:)
   - [ ] Make a little latex response PDF.
...
** [ ] 3. Fix writing: The reviewers point out quite some inconsistent and unclear writing in various places of the paper.
    ...
    - [ ] %XXX Neil should we remove this cite? Aranda et al.~\cite{aranda09icse} explored \emph{why}, in
