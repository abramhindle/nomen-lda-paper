...
** [ ] 3. Fix writing: The reviewers point out quite some inconsistent and unclear writing in various places of the paper.
    - [ ] Clean Up Writing
    - [ ] Beginning of abstract (i.e., original problem statement) is
    ...
    - [ ] Soften or qualify the claim by either alluding to or
   ...
   - [ ] what is 748 again? \emph{correctness} (182/305/748, which represent MySQL, MaxDB and PostgreSQL topic counts, respe
...
an issue).
   ...
   - [ ] The differences between exp1, exp2, and exp3 are difficult
   ...
   - [ ] 3.2.3, last para: "Many ROC scores were 0.6 or less, but our
     classifier, in most cases, still performed substantially better
     than random." -- is this the only discussion of the ROC results
     presented in Figure 2? The paper would benefit from a discussion
     (as a paragraph, rather than a single sentence) of Figure 2 if
     the authors plan on including it.
...
this could be explained better.
    ...
    - [ ] Fig 7 is very hard to interpret. Needs more explanation in
    ...
    - [ ] The sentence "This diagram shows that petere, tgl and
    ...
    - [ ] Fig 8 needs more explanation of how it should be read. For
    ...
    - [ ] The cite in the first sentence of 5 does not clearly support
    ...
    - [ ] - 5.2, p. 21 lines 48-49: Please revise "We had to evaluate
    ...
    - [ ] Page 19: "our theory is that the less frequent committers
...
** 4. Honestly address the IRR and validity issues
   ...
   - [ ] Am I right in saying that you actually continued with two
   ...
   - [ ] There must be a clear indicator that these results are
     threatened by the low IRR in the conclusion.
   - [ ]  5.2 As I've mentioned and as you admit, this is a major
   ...
   - [ ] This section was very interesting but the low IRR makes me
