* TODOs - final edit for minor comments
** Reviewer 2 [1/22]
   - [ ] text label size on Fig 2, 6, 9
   ...
   - [ ] 5.5, last sentence: "other domains"
   ...
   - [ ]  Intro, 2nd para: please define the terms NFR & project dashboard before using.
   - [ ] p 3, l 7: "topic trends --" the second -- needs a transition word after it like and/where, or could be changed to a period.
   - [ ] p3 l9: "is further emphasized in this paper..." is this point really pertinent here? Aren't the authors still trying to motivate the purpose of the work they've undertaken in the current paper at this point in the intro?
   - [ ] p3, l49: bad page turn, use nonbreaking space for Section~4. Also bad line break for p5, l9 milestone~3.
   - [ ] p6, l35: bucket -> buckets
   - [ ]  top of p8: low-ercase is bad line break
   - [ ] p14 l15 just before 3.3: do "quality word lists" mean exp2 & 3? Can this be made more explicit?
   - [ ]   - 3.4, p16, l47: "labels.During" -- needs space
   - [ ]    - p20, l15: "August, 2002," -> August 2002,
   - [ ]    - p21, l44: "This will group" -> This groups?
   - [ ] - p21, l47: "the path We" -> the path. We
   ...
   - [ ]    - p22, l46: "developers are have different" -> remove are
   - [ ]    - p23, l49: "Whereas, ..." This sentence seems to be missing a clause, and does not make sense as a stand alone sentence.
   - [ ]    - Fig 8: can't read tgl in the upper right -- can the authors just plot momjian & then add the tgl label in post processing? The other overlapping author names aren't an issue, but tgl & momjian are used as examples for the reader to refer to in the text.
...
** Reviewer 3  [0/6]
   ...
   - [ ] Sentence starting with "Researchers have.." is a run-on sentence.
   - [ ] Flow between "However, these word-lists.." and "Current topic modeling.." sentences is poor.
