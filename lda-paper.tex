...
distributions from these messages. These distributions are bucketted
...
mailinglist and the names of some patc contributors.  Other repeating
...
finally had a topic with optimizer in its topic ten words. This shows
...
mentioned \emph{Perl} in 4 different topics and 1 global
...
across the whole development history of a project, we refer to this as \emph{global topic
  analysis}.% is topic analysis applied against the entire lifetime of a
%project.

We carried otu \emph{global topic analysis} on MaxDB 7.500 and
...
of stopwords could be biased, and could affect the results.
