...
that is a tool that would also automate check-ins using a Perforce SCS
...
lot of changes while other months have almost none.
%   1.   validation
...
reoccurs over time. These visualizations help us get an overall
feeling about the common and unique topics that developers focus
on. If implemented properly a user could easily zoom in and query a
