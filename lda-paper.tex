...
Trends are interesting because they that topic during development has occured over more thanone period.
}
...
preserve indepedent topics but seemed to be a threshold
...
\ref{fig:statictopics}, explained in Section \ref{ref:compare}) it is not in any of the topics. A query
...
Windowed topic analysis demonstrated its ability to hilight local topics
