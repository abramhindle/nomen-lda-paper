...
\hla{ Visualization is an integral part of our topics analysis which
...
\hla{ The \emph{trend-histogram} (Figure \ref{fig:histogram}) attempts
...
long. \hla{ The \emph{trend-histogram} summarizes the distribution of
trends ordered by size. }

\hla{ All of these visualization combine to enable an analysis of
