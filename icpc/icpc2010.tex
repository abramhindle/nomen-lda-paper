...
\begin{abstract}
%  Within the field of mining software repositories, many approaches,   such as topic modeling and concept location, rely on the automated   application of machine learning algorithms to corpora.  
To have a meaningful discussion about the progress of software development, we must be able to devise appropriate labels for development topics. We can then categorize development artifacts as belonging to one or more of these topics. 
In order to do this, approaches such as topic modeling and concept location rely on the automated application of machine learning algorithms to development artifacts. 
